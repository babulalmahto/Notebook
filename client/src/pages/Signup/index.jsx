    ...
    return <div>
        <div className="sign-container">
            ...
            <form action="" onSubmit={onSubmitHandler}>
                ...
                { user.languages.length < 5 && <button className="Add-field" type="button" onClick={() => {
                ...
                <input className="dob-field" type="text" name="date" onChange={onDateEnter} />
                <input className="dob-field" type="text" name="month" onChange={onDateEnter} />
                <input className="dob-field" type="text" name="year" onChange={onDateEnter}/>
